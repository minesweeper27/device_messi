 ...
 */
#define LOG_TAG "android.hardware.health@2.0-service.messi"
...
using ::device::motorola::messi::health::CycleCountBackupRestore;
using ::device::motorola::messi::health::LearnedCapacityBackupRestore;
